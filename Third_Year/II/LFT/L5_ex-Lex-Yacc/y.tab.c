...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_linii = 6,                      /* linii  */
  YYSYMBOL_olinie = 7                      /* olinie  */
};
...
static const char *const yytname[] =
{
  ...
  "$accept", "linii", "olinie", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* linii: linii olinie NEWLINE  */
#line 8 "print-int.y"
                               {printf("identifica nr.=%d\n", yyvsp[-1]);}
#line 1100 "y.tab.c"
    break;

  case 5: /* linii: error NEWLINE  */
#line 9 "print-int.y"
                        { 
