...
inline SDL_Event currentEvent;
inline float cameraZ { 3.0f };

extern float depthBuffer[WINDOW_WIDTH][WINDOW_HEIGHT];

inline egc::vec2 getZminZmax(tinyobj::shape_t shape) {
...
inline std::vector<tinyobj::shape_t> readOBJ(std::string inputfile)
{
...
inline void validateViewingTransformations()
{
