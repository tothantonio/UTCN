...
namespace egc {
    ...
    inline mat3 translate(const vec2 translateArray){
    ...
    inline mat3 scale(const vec2 scaleArray) {
        mat3 matrix = mat3();
    ...
    inline mat4 translate(const vec3 translateArray) {
    ...
    inline mat4 scale(const vec3 scaleArray) {
        mat4 matrix = mat4();
        matrix.at(0, 0) = scaleArray.x;
        matrix.at(1, 1) = scaleArray.y;
