...
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('1','Aiben','Angela',to_date('12/20/2002','mm/dd/yyyy'),'F','3241','7','10','3');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('2','Belc','Viorel',to_date('05/27/2002','mm/dd/yyyy'),'M','3241',null,'10','5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('3','Berindean','Coralia',to_date('03/21/2001','mm/dd/yyyy'),'F','3241',null,'10','5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('4','Butmalai','Catalin',to_date('02/26/2002','mm/dd/yyyy'),'M','3241','15','10','1');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('5','Brad','Marilena',to_date('05/14/2003','mm/dd/yyyy'),'F','3241',null,'10','2');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('6','Costin','Ovidiu',to_date('07/27/2004','mm/dd/yyyy'),'M','3241',null,'10','4');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('7','Costin','Radu',to_date('11/04/2003','mm/dd/yyyy'),'M','3241','1','10','3');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('8','Demian','Calin',to_date('08/04/2003','mm/dd/yyyy'),'M','3241','21','10','6');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('9','Dragan','Teodora',to_date('09/23/2003','mm/dd/yyyy'),'F','3241','12','10','6');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('10','Kiss','Zoltan',to_date('01/27/2003','mm/dd/yyyy'),'M','3241',null,null,'7');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('11','Tabirta','Vadim',to_date('07/30/2003','mm/dd/yyyy'),'M','3241',null,'10','5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('12','Harangus','Dan',to_date('01/20/2003','mm/dd/yyyy'),'M','3241','9','20','6');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('13','Muresan','Mirel',to_date('01/23/2003','mm/dd/yyyy'),'M','3241',null,'20','8');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('14','Pacurar','Gheorghe',to_date('07/24/2004','mm/dd/yyyy'),'M','3241',null,'20','8');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('15','Prata','Adriana',to_date('12/26/2003','mm/dd/yyyy'),'F','3241','4','20','1');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('16','Sasebes','Claudiu',to_date('10/04/2003','mm/dd/yyyy'),'M','3241',null,'20','8');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('17','Roman','Adrian',to_date('10/27/2003','mm/dd/yyyy'),'M','3241',null,'20','5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('18','Tocaciu','Radu',to_date('03/28/2004','mm/dd/yyyy'),'M','3241',null,'20','10');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('19','Toderici','Leontin',to_date('07/03/2000','mm/dd/yyyy'),'M','3241',null,'20','8');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('20','Tudor','Dan',to_date('03/22/2004','mm/dd/yyyy'),'M','3241',null,null,'5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('21','Vonica','Cosmina',to_date('10/02/2003','mm/dd/yyyy'),'F','3241','8','20','6');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('22','Rus','Mircea',to_date('06/26/2004','mm/dd/yyyy'),'M','3241',null,'20','9');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('23','Alexandru','Mihai',to_date('06/23/2000','mm/dd/yyyy'),'M','3242',null,null,'8');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('24','Babota','Radu',to_date('07/29/2004','mm/dd/yyyy'),'M','3242',null,'23','2');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('25','Ceuca','Dana',to_date('09/03/2003','mm/dd/yyyy'),'F','3242','40','23','2');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('26','Cornea','Stelian',to_date('11/16/2000','mm/dd/yyyy'),'M','3242',null,'23','8');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('27','Cristea','Titus',to_date('09/22/2004','mm/dd/yyyy'),'F','3242',null,'23','5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('28','Galea','Gabriela',to_date('10/21/2003','mm/dd/yyyy'),'M','3242',null,'23','6');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('29','Iosivas','Mihai',to_date('06/26/2003','mm/dd/yyyy'),'M','3242',null,'23','5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('30','Lupu','Cristian',to_date('12/25/2003','mm/dd/yyyy'),'M','3242',null,'23','2');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('31','Petrescu','Amelia',to_date('05/21/2003','mm/dd/yyyy'),'F','3242',null,'23','11');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('32','Mirza','Narcis',to_date('09/26/2004','mm/dd/yyyy'),'M','3242',null,'23','5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('33','Cistelecan','Dana',to_date('07/02/2003','mm/dd/yyyy'),'F','3242',null,'23','12');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('34','Mindru','Adrian',to_date('01/23/2003','mm/dd/yyyy'),'M','3242',null,'36','14');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('35','Moldovan','Steliana',to_date('03/18/2003','mm/dd/yyyy'),'F','3242',null,'36','13');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('36','Muresan','Ovidiu',to_date('07/20/2003','mm/dd/yyyy'),'M','3242',null,null,'10');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('37','Paius','Radu',to_date('02/28/2003','mm/dd/yyyy'),'M','3242',null,'36','5');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('38','Plesca','Miana',to_date('09/22/2003','mm/dd/yyyy'),'F','3242',null,'36','8');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('39','Preda','Razvan',to_date('09/25/2004','mm/dd/yyyy'),'M','3242',null,'36','2');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('40','Rusu','Ovidiu',to_date('10/07/2003','mm/dd/yyyy'),'M','3242','25','36','2');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('41','Schillo','Alexandru',to_date('06/02/2003','mm/dd/yyyy'),'M','3242',null,'36','14');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('42','Topircean','Ioan',to_date('12/19/2003','mm/dd/yyyy'),'M','3242',null,'36','8');
Insert into STUDENT (NR_MATR,NUME,PRENUME,DATA_N,GEN,GRUPA,SOT,RESP_GRUPA,CODA) values ('43','Zetea','Tudor',to_date('02/19/2003','mm/dd/yyyy'),'M','3242',null,'36','15');
